...
$con=trim(mysql_real_escape_string($_POST["newcon"]));
...
$s="select country_name from country_master";
$q = mysql_query($s,$link);
while($row=mysql_fetch_array($q))
{
if(strtolower($row['country_name'])==strtolower($con))
{
if(!(@$code=="1"))
		{
if(!(@$code=="2"))
...
{
$insert1 = "INSERT INTO country_master (country_id, country_name, delete_flag) VALUES (NULL, '$con', '0');";
		...
		<div id="site_content">
          ...
          <div class="content-inner">
			<?php
				...
				{
					echo "<center>";
					echo "<h2>Country Master</h2>";
					echo "<table align=center>";
					echo "<th>Sr No.</th>";
					echo "<th align='center'>Country<br>Code</th>";
					echo "<th align='center'>Country Name</th>";
					echo "<th>Status</th>";
					...
					while($row=mysql_fetch_array($query))
					{
						...
						echo "<td align='center'>";
							$concode=$row['country_id'];
							echo $concode;
						echo "</td>";
						echo "<td>";
							echo "<center>".$row['country_name']."</center>";
						echo "</td>";
						echo "<td>";
						...
						echo "<td>";
							if($row['delete_flag']==0)
							{
							echo "<a href=\"admin/del_con.php? concode={$concode}\">"."Deactivate"."</a>";
							}
							if($row['delete_flag']==1)
							{
							echo "<a href=\"admin/rec_con.php? concode={$concode}\">"."Activate"."</a>";
							}
						echo "</td>";
						/*echo "<td>";
							if($row['delete_flag']==1)
					...
					if(isset($_GET['addmore']))
						{
							...
							echo "<td>";
								?>
								<input type="text" name="newcon" size="15" placeholder="Country" value="<?php if(isset($con)){echo $con;} ?>"/> <?php if(isset($error[1])){?><span class="jekil"><?php echo $error[1];} if(isset($error[2])){?><span class="jekil"><?php echo $error[2];} ?></span> <?php if(isset($error[3])){?><span class="jekil"><?php echo $error[3];} ?></span>
								<?php
							echo "</td>";
							echo "<td>";
