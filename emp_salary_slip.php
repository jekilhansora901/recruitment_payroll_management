...
/*$m=date('M-Y');
$fourmonthsback = mktime(0, 0, 0, date("m")-1, date("d"),   date("Y"));
$m=date('M-Y',$fourmonthsback);
$pdf->setHeaderData('','',"Ashapura Volclay Pvt. Ltd.","Pay Slip for : $m");
...
$str="Jekil";
	...
	$sql="select * from salary,emp_personal_detail,department_detail,desg_detail where emp_personal_detail.dept_code=department_detail.dept_code AND emp_personal_detail.desg_code=desg_detail.desg_code and emp_personal_detail.emp_code=salary.emp_code and emp_personal_detail.emp_code='$empcode' AND salary.month='$month';";
