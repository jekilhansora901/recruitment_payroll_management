				...
				if($no_row>0)
				{
					...
					while($row=mysql_fetch_array($query))
					{
						...
						echo "<td>";
							$image=$row ['img'];
								?>
									<img src="images/slideshow/<?php echo $image; ?>"  width="303" height="199" />
								<?php
							echo "</td>";
						echo "<td>";
							echo "<a href=\"admin/delimg.php? photo={$row['img']}\">"."Delete"."</a>";
						echo "</td>";
						echo "</tr>";
					}
					echo "<tr>";
					...
					echo "<td />";
					echo "<td>";
						echo "<a href='admin_add_img.php'>Add More Images </a>";
					echo "</td>";
					echo "</tr>";
					echo "</table>";
				}
